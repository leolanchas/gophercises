...
[Gophercies](https://courses.calhoun.io/lessons/les_goph_06) using the go standard [layout](https://github.com/golang-standards/project-layout).

Choose your own adventure: [github](https://github.com/gophercises/cyoa).
